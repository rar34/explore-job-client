            ...
            <div className="container justify-between flex flex-col px-6 md:px-24 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
                <div className="w-full lg:w-1/2">
                    <div className="lg:max-w-lg">
                        <h1 className="text-3xl font-semibold tracking-wide mb-4 text-blue-400 dark:text-white lg:text-4xl">
                            DOWNLOAD & ENJOY
                        </h1>
                        <h1 className="text-5xl font-bold">Get the Job Search App</h1>
                        <p className="my-6">Search through millions of jobs and find the right fit. Simply
