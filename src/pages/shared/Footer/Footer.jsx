                    ...
                    <nav>
                        ...
                        <div className="mt-6 text-xl">
                            <div className="text-left">
                                <p className="flex items-center  mb-2 gap-4"><BsFillTelephoneFill /><span className="text-base">658 442 152222</span></p>
                                <p className="flex items-center  mb-2 gap-4"><MdEmail /><span className="text-base">info@exlore.job</span></p>
                                <p className="flex items-center mb-2 gap-4"><FaLocationDot /><span className="text-base">Gulshan, Dhaka Bangladesh</span></p>
                            </div>
                        </div>
                    </nav>
                </footer>
